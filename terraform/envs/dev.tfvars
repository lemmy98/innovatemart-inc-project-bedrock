# Dev values — same exam names (only one live stack per account).
# Smaller nodes / shorter logs to save money while iterating.
...
# Oldest Kubernetes version in EKS *standard* support as of 2026-08 (1.33 is extended-only).
# t3.small is the smallest node that can actually schedule this app (t3.micro is 1 GiB).
